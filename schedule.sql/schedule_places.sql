...
CREATE TABLE `places` (
  ...
  `id_buildings` bigint(20) NOT NULL COMMENT 'id строения в котором расположено',
  `status` tinyint(11) NOT NULL COMMENT 'состояние',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='местоположения';
