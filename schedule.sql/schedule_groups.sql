...
CREATE TABLE `groups` (
  ...
  `name` varchar(255) NOT NULL COMMENT 'название учебной группы',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'состояние',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='учебные группы';
