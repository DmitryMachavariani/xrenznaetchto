...
CREATE TABLE `weeks` (
  ...
  `number` int(11) NOT NULL COMMENT 'номер недели внутри сезона',
  `id_seasons` bigint(20) NOT NULL COMMENT 'id сезона',
  `week_start_day` date NOT NULL,
  `week_finish_day` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='недели для расписания';
