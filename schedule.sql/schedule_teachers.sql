...
CREATE TABLE `teachers` (
  ...
  `secondname` varchar(255) NOT NULL COMMENT 'отчество',
  `lastname` varchar(255) NOT NULL COMMENT 'фамилия',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'активирован',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='преподаватели';
