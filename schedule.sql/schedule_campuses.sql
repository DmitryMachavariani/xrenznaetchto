...
CREATE TABLE `campuses` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='кампусы';
...
INSERT INTO `campuses` VALUES (1,'Голландия'),(2,'Стрелка'),(3,'Морской колледж'),(4,'Гоголя'),(5,'Гуманитарный институт');
